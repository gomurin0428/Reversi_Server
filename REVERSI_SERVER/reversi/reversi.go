...
func PutStoneToSpecifiedSiteAndReverse(putStoneSite int64, player int64, opponent int64) (int64, int64) {
	var reverse int64 = 0
	reverse |= getReverseTargetForSpecifiedDirection(putStoneSite, player, opponent, "right", 1, horizontalMask)
	reverse |= getReverseTargetForSpecifiedDirection(putStoneSite, player, opponent, "left", 1, horizontalMask)
	reverse |= getReverseTargetForSpecifiedDirection(putStoneSite, player, opponent, "right", 5, allSideMask)
	reverse |= getReverseTargetForSpecifiedDirection(putStoneSite, player, opponent, "left", 5, allSideMask)
	reverse |= getReverseTargetForSpecifiedDirection(putStoneSite, player, opponent, "right", 6, verticalMask)
	reverse |= getReverseTargetForSpecifiedDirection(putStoneSite, player, opponent, "left", 6, verticalMask)
	reverse |= getReverseTargetForSpecifiedDirection(putStoneSite, player, opponent, "right", 7, allSideMask)
	reverse |= getReverseTargetForSpecifiedDirection(putStoneSite, player, opponent, "left", 7, allSideMask)
...
func getReverseTargetForSpecifiedDirection(putStoneSite int64, player int64, opponent int64, shift_direction string, shift_count int, mask string) int64 {

	var tmp int64

	if shift_direction == "right" {
		tmp = bitStringTo64BitInt(mask) & (putStoneSite >> int64(shift_count))
	} else {
		tmp = bitStringTo64BitInt(mask) & (putStoneSite << int64(shift_count))
	}
